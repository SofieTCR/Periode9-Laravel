        ...
        <div class="card-body grid grid-cols-1 gap-6 lg:grid-cols-1">
            <div class="p-4">
                ...
                <label class="block text-sm">
                    ...
                    <input class="bg-gray-200 block rounded w-full p-2 mt-1 focus:border-purple-400 focus:outline-none focus: shadow-outline-purple form-input" name="name" value="{{ old('name', $project->name) }}" type="text" required/>
                </label>
                <label class="block text-sm">
                    <span class="text-gray-700">Description</span>
                    <input class="bg-gray-200 block rounded w-full p-2 mt-1 focus:border-purple-400 focus:outline-none focus: shadow-outline-purple form-input" name="description" value="{{ old('description', $project->description) }}" type="text" required/>
                </label>
