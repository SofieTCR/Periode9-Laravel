...
<html lang="en">
	...
	<body>
		...
		<!-- nav -->
		<nav role="navigation" aria-label="Pagination Navigation" class="w-full bg-white md:pt-0 px-6 relative z-20 border-t border-b border-gray-300">
		...
		<div class="w-full px-6 py-12 bg-gray-100 border-t">
			...
			<div class="container max-w-4xl mx-auto pb-10 flex flex-wrap">
				...
				<div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-3 mb-4">
					...
					<p class="text-xs leading-normal">{{ $project->id }} {{ $project->description }}</p>
				</div>
